...
class AccountTest {
	...
	Account account1 = new Account(1,"cust101",6000,"savings",null,"Akash",null);
	...
	void setOwnerNameTest() {
		account.setOwnerName("Akash");
		assertEquals("Akash", account.getOwnerName());
	}
	...
	void setOwnerNameTest1() {
		account.setOwnerName("Akash");
		assertEquals("Akash", account1.getOwnerName());
	}
