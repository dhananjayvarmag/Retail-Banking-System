...
class TransactionTest {
	...
	Transaction transaction2 = new Transaction(1, 2, "Arun", 32, "Ajay", 1000, null, "deposit");
	...
	{
		tc.setSourceOwnerName("Arun");
		assertEquals("Arun", tc.getSourceOwnerName());
	}
	...
	{
		tc.setTargetOwnerName("Akash");
		assertEquals("Akash", tc.getTargetOwnerName());
	}
	...
	public void setTargetOwnerNameTest1() {
		assertEquals("Ajay", transaction2.getTargetOwnerName());
	}
	...
	public void setSourceOwnerTest1()
	{
		...
		assertEquals("Arun", transaction2.getSourceOwnerName());
	}
}
