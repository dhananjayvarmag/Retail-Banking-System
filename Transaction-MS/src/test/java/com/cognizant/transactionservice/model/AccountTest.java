...
class AccountTest {
	...
	Account account1 = new Account(1, "customer101", 10, "Savings",new Date(), "Shop", list);
	...
	void setOwnerNameTest() {
		account.setOwnerName("Shop");
		assertEquals("Shop", account.getOwnerName());
	}
	...
	void getOwnerTest() {
		account.setOwnerName("Shop");
		assertTrue(account.getOwnerName() == "Shop");
	}
}
